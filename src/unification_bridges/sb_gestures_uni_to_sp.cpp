...
{
  // ROS 1 node
  ros::init(argc, argv, "ros1_sb_gestures_uni_to_sp");
  ros::NodeHandle ros1_node;

  // ROS 2 node
  rclcpp::init(argc, argv);
  auto ros2_node = rclcpp::Node::make_shared("ros2_sb_gestures_uni_to_sp");

  // bridge one example topic
  std::string topic_name = "unification_roscontrol/gestures_uni_to_sp";
